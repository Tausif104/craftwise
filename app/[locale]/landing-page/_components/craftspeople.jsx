...
const testimonials = [
    {
        ...
        rating: 5,
        date: "06 July 2023",
        text: "Before CraftWise, quoting took hours. Now I send them in minutes. Clients appreciate the clear and professional look.",
        name: "Markus B.,",
        role: "Roofer",
        image: "/images/icons/user-01.png",
    },
    {
        id: 2,
        rating: 5,
        date: "20 July 2023",
        text: "Invoicing is quick and accurate. Templates and stored items save us time every week.",
        name: "Lara S.,",
        role: "Painter",
        image: "/images/icons/user-02.png",
    },
    {
        id: 3,
        rating: 5,
        date: "26 July 2023",
        text: "The system keeps our office and site teams in sync. Communication is clear and nothing gets lost.",
        name: "Daniel W.,",
        role: "Electrician ",
        image: "/images/icons/user-03.png",
    },
    {
        id: 4,
        rating: 5,
...
const Craftspeople = () => {
    ...
    return (
        <section className="pt-15 lg:pt-20  overflow-hidden">
            <div className="container">
                <h3 className=" text-center ">
                    Trusted by Real Craftspeople
                </h3>
                <p className=" text-center pt-4">Real Tradespeople. Real Results.</p>
