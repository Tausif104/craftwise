...
const CommonCardTwo = ({ icon, title, description, link, linkText = 'Learn More' }) => {
    const isImagePath = typeof icon === 'string' && (icon.startsWith('/') || icon.startsWith('http'));

    return (
        <div className="flex flex-col items-center text-center rounded-[16px] bg-white p-4 md:p-7.5 shadow-[0px_0px_18px_0px_#00000014] h-full transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
